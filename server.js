...
app.use('/api/catalog', require('./routes/supplement_stack')(getDB)) // #1489 stage E of #1485 — separate file, supplement_catalog.js untouched (Lucas stage C in same repo)
