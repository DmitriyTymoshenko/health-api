...
/**
 * Shift a YYYY-MM-DD string by N calendar days (negative = backward). Noon-UTC
 * anchor (same technique as lib/volume-by-muscle.js's private parseDateString/
 * addDays — this is the exported twin, added for #1099 so the day-type/week
 * resolvers get ONE date-arithmetic helper instead of a third private copy).
